...
//  }
  ...
  public static void main(String[] args)
  {
    ...
    int largest = worker.getLargest(nums);
    System.out.println("Largest should be 3 and largest is " + largest);
    
    int count = worker.getCount(1,nums);
    System.out.println("Count should be 6 and count is " + count);

    int colTotal = worker.getColTotal(nums,1,1);
    System.out.println("ColTotal should be 2 and count is " + colTotal);
